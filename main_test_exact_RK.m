...
close all
clc
load 'exact-solution-RK2-50.mat' 
%% TEST
...
save(['exact-solution-RK2-',num2str(M),'.mat']);
...
legend({'dom0', 'dom1', 'dom2','Order 1', 'Order 3/2'},...
        'Location', 'southwest');
